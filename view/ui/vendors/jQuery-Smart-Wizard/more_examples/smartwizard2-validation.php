...
<script type="text/javascript">
    ...
    $(document).ready(function(){
    	// Smart Wizard     	
  		$('#wizard').smartWizard({transitionEffect:'slideright',onLeaveStep:leaveAStepCallback,onFinish:onFinishCallback,enableFinishButton:true});
  		...
  		<div id="wizard" class="swMain">
            ...
            <table cellspacing="3" cellpadding="3" align="center">
          			...
          			<tr>
                    	...
                    	<td align="right"><span id="msg_username"></span>&nbsp;</td>
          			</tr>
          			<tr>
                    	...
                    	<td align="right"><span id="msg_password"></span>&nbsp;</td>
          			</tr> 
                <tr>
                    	...
                    	<td align="right"><span id="msg_cpassword"></span>&nbsp;</td>
          			</tr>                                   			
  			   </table>          			
        </div>
  			<div id="step-2">
            ...
            <table cellspacing="3" cellpadding="3" align="center">
          			...
          			<tr>
                    	...
                    	<td align="right"><span id="msg_firstname"></span>&nbsp;</td>
          			</tr>
          			<tr>
                    	...
                    	<td align="right"><span id="msg_lastname"></span>&nbsp;</td>
          			</tr> 
          			<tr>
                    	...
                    	<td align="right"><span id="msg_gender"></span>&nbsp;</td>
          			</tr>                                   			
  			   </table>        
        </div>                      
  			<div id="step-3">
            ...
            <table cellspacing="3" cellpadding="3" align="center">
          			...
          			<tr>
                    	...
                    	<td align="right"><span id="msg_email"></span>&nbsp;</td>
          			</tr>
          			<tr>
                    	...
                    	<td align="right"><span id="msg_phone"></span>&nbsp;</td>
          			</tr>          			
          			<tr>
                    	...
                    	<td align="right"><span id="msg_address"></span>&nbsp;</td>
          			</tr>                                   			
  			   </table>               				          
        </div>
  			<div id="step-4">
