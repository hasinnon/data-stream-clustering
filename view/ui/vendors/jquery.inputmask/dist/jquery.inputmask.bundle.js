...
* Copyleft (c) 2010 - 2016 Robin Herbots
...
!function($) {
    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function caret(input, begin, end, notranslate) {
            ...
            if (input.scrollRight = scrollCalc > input.scrollWidth ? scrollCalc : 0, mobile || opts.insertMode !== !1 || begin !== end || end++, 
        ...
        function keydownEvent(e) {
            ...
            caret(input, pos.begin, pos.end))) : opts.insertMode !== !1 || e.shiftKey || (k === Inputmask.keyCode.LEFT ? setTimeout(function() {
                var caretPos = caret(input);
                caret(input, caretPos.begin);
            }, 0) : k === Inputmask.keyCode.RIGHT && setTimeout(function() {
                var caretPos = caret(input);
        ...
        function mask(elem) {
            ...
            ("rtl" === el.dir || opts.leftAlign) && (el.style.textAlign = "left"), ("rtl" === el.dir || opts.numericInput) && (el.dir = "ltr", 
    ...
    return Inputmask.extendDefinitions({
        ...
        "dd/mm/yyyy": {
            ...
            onKeyDown: function(e, buffer, caretPos, opts) {
                var $input = $(this);
                if (e.ctrlKey && e.keyCode === Inputmask.keyCode.LEFT) {
                    var today = new Date();
