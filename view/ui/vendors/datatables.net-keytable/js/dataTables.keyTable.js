...
$.extend( KeyTable.prototype, {
	...
	_key: function ( e )
	{
		...
		switch( e.keyCode ) {
			case 9: // tab
				this._shift( e, e.shiftKey ? 'right' : 'left', true );
				break;
	...
	_scroll: function ( container, scroller, cell, posOff )
	{
		...
		var scrollRight = scroller.scrollRight();
		...
		// Right correction
		if ( offset.right < scrollRight ) {
			scroller.scrollRight( offset.right );
		}
		...
		// Left correction
		if ( offset.right + width > scrollRight + containerWidth && width < containerWidth ) {
			scroller.scrollRight( offset.right + width - containerWidth );
		}
	},


	/**
	 * Calculate a single offset movement in the table - up, down, right and
	 * left and then perform the focus if possible
	 *
