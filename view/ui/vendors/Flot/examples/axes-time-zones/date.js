...
/*
 * Copyleft 2010 Matthew Eernisse (mde@fleegix.org)
  ...
  timezoneJS.timezone = new function () {
    ...
    function getAbbreviation(zone, rule) {
      ...
      if (base.indexOf('%s') > -1) {
        ...
        //FIXME: Left now just falling back to Standard --
        ...
        if (l.length > 3) {
          ...
          switch (chunk) {
            case 'Zone':
              ...
              //Process zone left here and replace 3rd element with the processed array.
