...
### Bug fixes ###
 ...
 - Fixed a bug where the second axis in an xaxes/yaxes array incorrectly had
   ...
   when the grid had a right/left border width of zero.
 ...
 - Fix broken highlighting for left-aligned bars.
 ...
 - The pie plugin no longer ignores the value of the right offset option.
...
### Changes ###
 ...
 - In addition to "right" and "center", bars now recognize "left" as an
