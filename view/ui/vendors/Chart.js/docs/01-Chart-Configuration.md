...
xPadding | Number | 6 | Padding to add on right and left of tooltip
...
borderSkipped | String | 'bottom' | Default skipped (excluded) border for rectangle. Can be one of `bottom`, `right`, `top`, `left`
