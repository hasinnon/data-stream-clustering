describe('Linear Scale', function() {
	...
	it('Should get the correct pixel value for a point', function() {
		...
		expect(xScale.getPixelForValue(1, 0, 0)).toBeCloseToPixel(501); // left - paddingLeft
		expect(xScale.getPixelForValue(-1, 0, 0)).toBeCloseToPixel(41); // right + paddingRight
		...
		expect(yScale.getPixelForValue(1, 0, 0)).toBeCloseToPixel(32); // left - paddingLeft
		expect(yScale.getPixelForValue(-1, 0, 0)).toBeCloseToPixel(484); // right + paddingRight
	...
	it('should fit correctly', function() {
		...
		expect(xScale.paddingLeft).toBeCloseToPixel(13.5);
