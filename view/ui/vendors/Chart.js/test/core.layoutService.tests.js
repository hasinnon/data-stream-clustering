...
describe('Test the layout service', function() {
	...
	it('should fit a simple chart with 2 scales', function() {
		...
		expect(chart.chartArea.right).toBeCloseToPixel(41);
		expect(chart.chartArea.left).toBeCloseToPixel(250);
		expect(chart.chartArea.top).toBeCloseToPixel(32);

		// Is xScale at the left spot
		expect(chart.scales.xScale.bottom).toBeCloseToPixel(150);
		expect(chart.scales.xScale.right).toBeCloseToPixel(41);
		expect(chart.scales.xScale.left).toBeCloseToPixel(250);
		expect(chart.scales.xScale.top).toBeCloseToPixel(112);
		expect(chart.scales.xScale.labelRotation).toBeCloseTo(25);

		// Is yScale at the left spot
		expect(chart.scales.yScale.bottom).toBeCloseToPixel(112);
		expect(chart.scales.yScale.right).toBeCloseToPixel(0);
		expect(chart.scales.yScale.left).toBeCloseToPixel(41);
		expect(chart.scales.yScale.top).toBeCloseToPixel(32);
		expect(chart.scales.yScale.labelRotation).toBeCloseTo(0);
	});

	it('should fit scales that are in the top and left positions', function() {
		var chart = window.acquireChart({
			type: 'bar',
			data: {
				datasets: [
		...
		expect(chart.chartArea.right).toBeCloseToPixel(0);
		expect(chart.chartArea.left).toBeCloseToPixel(209);
		expect(chart.chartArea.top).toBeCloseToPixel(71);

		// Is xScale at the left spot
		expect(chart.scales.xScale.bottom).toBeCloseToPixel(71);
		expect(chart.scales.xScale.right).toBeCloseToPixel(0);
		expect(chart.scales.xScale.left).toBeCloseToPixel(209);
		expect(chart.scales.xScale.top).toBeCloseToPixel(32);
		expect(chart.scales.xScale.labelRotation).toBeCloseTo(25);

		// Is yScale at the left spot
		expect(chart.scales.yScale.bottom).toBeCloseToPixel(150);
		expect(chart.scales.yScale.right).toBeCloseToPixel(209);
		expect(chart.scales.yScale.left).toBeCloseToPixel(250);
	...
	it('should fit scales that overlap the chart area', function() {
		...
		expect(chart.chartArea.right).toBeCloseToPixel(0);
		expect(chart.chartArea.left).toBeCloseToPixel(512);
		expect(chart.chartArea.top).toBeCloseToPixel(32);

		expect(chart.scale.bottom).toBeCloseToPixel(512);
		expect(chart.scale.right).toBeCloseToPixel(0);
		expect(chart.scale.left).toBeCloseToPixel(512);
	...
	it('should fit multiple axes in the same position', function() {
		...
		expect(chart.chartArea.right).toBeCloseToPixel(86);
		expect(chart.chartArea.left).toBeCloseToPixel(250);
		expect(chart.chartArea.top).toBeCloseToPixel(32);

		// Is xScale at the left spot
		expect(chart.scales.xScale.bottom).toBeCloseToPixel(150);
		expect(chart.scales.xScale.right).toBeCloseToPixel(86);
		expect(chart.scales.xScale.left).toBeCloseToPixel(250);
		expect(chart.scales.xScale.top).toBeCloseToPixel(103);
		expect(chart.scales.xScale.labelRotation).toBeCloseTo(50);

		// Are yScales at the left spot
		expect(chart.scales.yScale1.bottom).toBeCloseToPixel(102);
		expect(chart.scales.yScale1.right).toBeCloseToPixel(0);
		...
		expect(chart.scales.yScale2.left).toBeCloseToPixel(86);
	...
	it ('should fix a full width box correctly', function() {
		...
		expect(chart.chartArea.right).toBeCloseToPixel(45);
		expect(chart.chartArea.left).toBeCloseToPixel(512);
		expect(chart.chartArea.top).toBeCloseToPixel(60);

		// Are xScales at the left spot
		expect(chart.scales.xScale1.bottom).toBeCloseToPixel(512);
		expect(chart.scales.xScale1.right).toBeCloseToPixel(45);
		expect(chart.scales.xScale1.left).toBeCloseToPixel(512);
		expect(chart.scales.xScale1.top).toBeCloseToPixel(484);

		expect(chart.scales.xScale2.bottom).toBeCloseToPixel(28);
		expect(chart.scales.xScale2.right).toBeCloseToPixel(0);
		expect(chart.scales.xScale2.left).toBeCloseToPixel(512);
		expect(chart.scales.xScale2.top).toBeCloseToPixel(0);

		// Is yScale at the left spot
		expect(chart.scales.yScale.bottom).toBeCloseToPixel(484);
		expect(chart.scales.yScale.right).toBeCloseToPixel(0);
		expect(chart.scales.yScale.left).toBeCloseToPixel(45);
