describe('Logarithmic Scale tests', function() {
	...
	it('should get the correct pixel value for a point', function() {
		...
		expect(xScale.getPixelForValue(80, 0, 0)).toBeCloseToPixel(495);  // left - paddingLeft
		expect(xScale.getPixelForValue( 1, 0, 0)).toBeCloseToPixel(48);   // right + paddingRight
		expect(xScale.getPixelForValue(10, 0, 0)).toBeCloseToPixel(283);  // halfway
		expect(xScale.getPixelForValue( 0, 0, 0)).toBeCloseToPixel(48);   // 0 is invalid, put it on the right.
