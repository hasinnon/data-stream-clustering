...
"none").appendTo("body").fadeIn(e.fade);var f=e._collection.css("position");h&&"absolute"===f?e._collection.css({top:h.top+5,right:h.right+5}):"absolute"===f?(e._collection.css({top:a.top+c.outerHeight(),right:a.right}),c=a.right+e._collection.outerWidth(),g=g.offset().right+g.width(),c>g&&e._collection.css("right",a.right-(c-g))):(a=e._collection.height()/2,a>d(o).height()/2&&(a=d(o).height()/2),e._collection.css("marginTop",-1*a));e.background&&m.background(!0,e.backgroundClassName,e.fade);setTimeout(function(){d("div.dt-button-background").on("click.dtb-collection",
