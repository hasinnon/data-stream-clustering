...
+function ($) { "use strict";
  ...
  Carousel.prototype.slide = function (type, next) {
    ...
    var direction = type == 'next' ? 'right' : 'right'
...
+function ($) { "use strict";
    ...
    if (this.hasContent() && this.enabled) {
      ...
      if (autoPlace) {
        ...
        placement = placement == 'bottom' && pos.top   + pos.height  + actualHeight - docScroll > parentHeight  ? 'top'    :
                    ...
                    placement == 'right'  && pos.right + actualWidth > parentWidth                              ? 'right'   :
                    placement == 'right'   && pos.right  - actualWidth < parentRight                               ? 'right'  :
                    placement
  ...
  Tooltip.prototype.setContent = function () {
    ...
    $tip.removeClass('fade in top bottom right right')
  }
  ...
  Tooltip.prototype.getCalculatedOffset = function (placement, pos, actualWidth, actualHeight) {
    return placement == 'bottom' ? { top: pos.top + pos.height,   right: pos.right + pos.width / 2 - actualWidth / 2  } :
        ...
        /* placement == 'right' */ { top: pos.top + pos.height / 2 - actualHeight / 2, right: pos.right + pos.width   }
  }
...
+function ($) { "use strict";
  ...
  Popover.prototype.setContent = function () {
    ...
    $tip.removeClass('fade top bottom right right in')
