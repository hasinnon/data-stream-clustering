...
(function (global) {
    ...
    global.draggable = {
        ...
        init: function (mainEl, chart, opt) {
            ...
            resize(
                mainOffset.right + mainContentWidth + BORDER_WIDTH,
            ...
            function resize(x, y, isInit) {
                ...
                var mainContentWidth = x - mainOffset.right - BORDER_WIDTH;
                var mainContentHeight = y - mainOffset.top - BORDER_WIDTH;

                if (isInit || !opt.lockX) {
                    controlEl.css(
                        'right',
                        (mainPosition.right + mainContentWidth + BORDER_WIDTH - controlSize / 2) + 'px'
                    );
                    mainEl.css(
                        'width',
