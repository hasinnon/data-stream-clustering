define(function(require) {
    ...
    function pointToDataInCartesian(selRange, coordInfo) {
        ...
        var dataRightTop = cartesian.pointToData([selRange[0][0], selRange[1][0]], true);
        var dataLeftBottom = cartesian.pointToData([selRange[0][1], selRange[1][1]], true);

        return [
            asc([dataRightTop[0], dataLeftBottom[0]]), // x, using asc to handle inverse
            asc([dataRightTop[1], dataLeftBottom[1]]) // y, using asc to handle inverse
        ];
    }
