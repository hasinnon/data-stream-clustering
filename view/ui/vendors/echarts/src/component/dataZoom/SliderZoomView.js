    ...
    var SliderZoomView = DataZoomView.extend({
        ...
        _resetLocation: function () {
            ...
            var positionInfo = this._orient === HORIZONTAL
                ? {
                    // Why using 'left', because left should be used in vertical,
                    // and it is better to be consistent for dealing with position param merge.
                    left: ecSize.width - coordRect.x - coordRect.width,
                    top: (ecSize.height - DEFAULT_FILLER_SIZE - DEFAULT_LOCATION_EDGE_GAP),
                    width: coordRect.width,
                    height: DEFAULT_FILLER_SIZE
                }
                : { // vertical
                    left: DEFAULT_LOCATION_EDGE_GAP,
                    top: coordRect.y,
            ...
            zrUtil.each(['left', 'top', 'width', 'height'], function (name) {
        ...
        _updateDataInfo: function () {
            ...
            function setLabel(handleIndex) {
                ...
                var direction = graphic.transformDirection(
                    handleIndex === 0 ? 'left' : 'right', barTransform
                );
