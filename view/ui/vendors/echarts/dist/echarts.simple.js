	        ...
	        if (connectedGroups[groupId]) {
	            ...
	            for (var id in instances) {
	                ...
	                if (chart.group === groupId) {
	                    ...
	                    right = mathMin(boundingRect.right, right);
	                    top = mathMin(boundingRect.top, top);
	                    left = mathMax(boundingRect.left, left);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var ComponentModel = Model.extend({
	         ...
	         * Only support 'box' now (right/left/top/bottom/width/height).
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Layout helpers for each component positioning
	    ...
	    var LOCATION_PARAMS = ['right', 'left', 'top', 'bottom', 'width', 'height'];
	    ...
	    /**
	     * If x or x2 is not specified or 'center' 'right' 'left',
	    ...
	    layout.getLayoutRect = function (
	        ...
	        // If width is not specified, calculate width from right and left
	        if (isNaN(width)) {
	            width = containerWidth - left - horizontalMargin - right;
	        }
	        if (isNaN(height)) {
	        ...
	        // If right is not specified, calculate right from left and width
	        if (isNaN(right)) {
	            right = containerWidth - left - width - horizontalMargin;
	        }
	        if (isNaN(top)) {
	        ...
	        // Align right and top
	        switch (positionInfo.right || positionInfo.left) {
	            case 'center':
	                right = containerWidth / 2 - width / 2 - margin[3];
	                break;
	            case 'left':
	                right = containerWidth - width - horizontalMargin;
	                break;
	        }
	        ...
	        // If something is wrong and right, top, width, height are calculated as NaN
	        right = right || 0;
	        top = top || 0;
	        if (isNaN(width)) {
	            // Width may be NaN if only one value is given except width
	            width = containerWidth - right - (left || 0);
	        }
	        if (isNaN(height)) {
	        ...
	        var rect = new BoundingRect(right + margin[3], top + margin[0], width, height);
	        rect.margin = margin;
	        return rect;
	    };
	     ...
	     *  If all properties exists, left and bottom will be igonred.
	     *
	     * @param {module:zrender/container/Group} group
	     * @param {Object} positionInfo
	     * @param {number|string} [positionInfo.right]
	    ...
	    /**
	     * Consider Case:
	     * When defulat option has {right: 0, width: 100}, and we set {left: 0}
	     * through setOption or media query, using normal zrUtil.merge will cause
	     * {left: 0} does not take effect.
	     *
	     * @example
	    ...
	    layout.mergeLayoutParam = function (targetOption, newOption, opt) {
	        ...
	        var hNames = ['width', 'right', 'left']; // Order by priority.
	        ...
	        function merge(names) {
	            ...
	            // Case: newOption: {width: ..., left: ...},
	            // or targetOption: {left: ...} and newOption: {width: ...},
	    ...
	    /**
	     * Retrieve 'right', 'left', 'top', 'bottom', 'width', 'height' from object.
	     * @param {Object} source
	...
	'use strict';
	    ...
	    var SeriesModel = ComponentModel.extend({
	        ...
	        formatTooltip: function (dataIndex, multipleSeries, dataType) {
	            ...
	            var colorEl = '<span style="display:inline-block;margin-left:5px;'
...
/***/ function(module, exports) {
	 ...
	 */
	    ...
	    function fastMapToColor(normalizedValue, colors, out) {
	        ...
	        var rightIndex = Math.floor(value);
	        var leftIndex = Math.ceil(value);
	        var rightColor = colors[rightIndex];
	        var leftColor = colors[leftIndex];
	        var dv = value - rightIndex;
	        out[0] = clampCssByte(lerp(rightColor[0], leftColor[0], dv));
	        out[1] = clampCssByte(lerp(rightColor[1], leftColor[1], dv));
	        out[2] = clampCssByte(lerp(rightColor[2], leftColor[2], dv));
	        out[3] = clampCssByte(lerp(rightColor[3], leftColor[3], dv));
	        return out;
	    }
	    /**
	     * @param {number} normalizedValue A float between 0 and 1.
	     ...
	     *                           return {color: ..., rightIndex: ..., leftIndex: ..., value: ...},
	     * @memberOf module:zrender/util/color
	     */
	    function mapToColor(normalizedValue, colors, fullOutput) {
	        ...
	        var color = stringify(
	            [
	                clampCssByte(lerp(rightColor[0], leftColor[0], dv)),
	                clampCssByte(lerp(rightColor[1], leftColor[1], dv)),
	                clampCssByte(lerp(rightColor[2], leftColor[2], dv)),
	                clampCssFloat(lerp(rightColor[3], leftColor[3], dv))
	            ],
	            'rgba'
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	     ...
	     * @param {Array.<number>} transform Transform matrix: like [1, 0, 0, 1, 0, 0]
	     * @param {boolean=} invert Whether use invert matrix.
	     * @return {string} Transformed direction. 'right' 'left' 'top' 'bottom'
	     */
	    graphic.transformDirection = function (direction, transform, invert) {
	        ...
	        var vertex = [
	            direction === 'right' ? -hBase : direction === 'left' ? hBase : 0,
	 ...
	 */
	    ...
	    bbox.fromPoints = function(points, min, max) {
	        ...
	        for (i = 1; i < points.length; i++) {
	            p = points[i];
	            right = mathMin(right, p[0]);
	            left = mathMax(left, p[0]);
	            top = mathMin(top, p[1]);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    function getBoundingClientRect(el) {
	        ...
	        return el.getBoundingClientRect ? el.getBoundingClientRect() : { right: 0, top: 0};
	    }
	    /**
	    ...
	    function normalizeEvent(el, e) {
	        ...
	        if (!isTouch) {
	            ...
	            if (touch) {
	                ...
	                // touch事件坐标是全屏的~
	                e.zrX = touch.clientX - rBounding.right;
	    ...
	    Painter.prototype = {
	        ...
	        _getWidth: function () {
	            ...
	            return ((root.clientWidth || parseInt10(stl.width) || parseInt10(root.style.width))
	                    ...
	                    - (parseInt10(stl.paddingLeft) || 0)) | 0;
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Compatitable with 2.0
	    ...
	    var LAYOUT_PROPERTIES = [
	        ['x', 'right'], ['y', 'top'], ['x2', 'left'], ['y2', 'bottom']
	    ];
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     * @param  {string} extraPrefix             Prefix of name when filling the right dimensions.
	     * @return {Array.<string>}
	     */
	        ...
	        function createAxisCreator(axisType) {
	            return function (axisModel, idx) {
	                ...
	                if (axisType === 'x') {
	                    ...
	                    // Fix position
	                    if (axisPosition !== 'right' && axisPosition !== 'left') {
	                        // Default right of Y
	                        axisPosition = 'right';
	                    }
	                    if (axisPositionUsed[axisPosition]) {
	                        axisPosition = axisPosition === 'right' ? 'left' : 'right';
	                    }
	                }
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    function layoutAxis(gridModel, axisModel) {
	        ...
	        var posMap = {
	            ...
	            y: {right: rectBound[0], left: rectBound[1]}
	        };
	        posMap.x.onZero = Math.max(Math.min(getZero('y'), posMap.x.bottom), posMap.x.top);
	        posMap.y.onZero = Math.max(Math.min(getZero('x'), posMap.y.left), posMap.y.right);
	        ...
	        var dirMap = {top: -1, bottom: 1, right: -1, left: 1};
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    function endTextLayout(opt, textPosition, extent) {
	        ...
	        var onRight = (textPosition === 'start' && !inverse)
	            || (textPosition !== 'start' && inverse);

	        if (isRadianAroundZero(rotationDiff - PI / 2)) {
	            verticalAlign = onRight ? 'bottom' : 'top';
	            textAlign = 'center';
	        }
	        else if (isRadianAroundZero(rotationDiff - PI * 1.5)) {
	            verticalAlign = onRight ? 'top' : 'bottom';
	            textAlign = 'center';
	        }
	        else {
	            verticalAlign = 'middle';
	    ...
	    module.exports = function (seriesModel, r, viewWidth, viewHeight) {
	        ...
	        data.each(function (idx) {
	            ...
	            if (labelPosition === 'center') {
	                ...
	                textAlign = isLabelInside ? 'center' : (dx > 0 ? 'right' : 'left');
	            }
