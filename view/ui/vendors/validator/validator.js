...
var validator = (function($){
    ...
    */
    message = {
        ...
        empty           : 'ورودی نباید خالی باشد',
        min             : 'مقدار ورودی خیلی کوچک است',
        max             : 'مقدار ورودی خیلی بزرگ است',
        number_min      : 'مقدار ورودی خیلی کوچک است',
        number_max      : 'مقدار ورودی خیلی بزرگ است',
        url             : 'invalid URL',
        number          : 'این ورودی عددی باید باشد',
