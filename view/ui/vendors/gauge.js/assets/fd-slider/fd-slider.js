 ...
 *
 * Copyleft 2010, 2011, Brian McAllister
        ...
        function fdRange(options) {
                ...
                function onMouseDown(e) {
                        ...
                        if(targ.className.search("fd-slider-handle") != -1) {                                
                                ...
                                handlePos = parseInt(vertical ? handle.offsetTop : handle.offsetRight)||0;                        
                        ...
                        // Wrapper mousedown - initiate animation to click point
                                ...
                                if (document.documentElement && document.documentElement.scrollTop) {
                                        ...
                                        sLft = document.documentElement.scrollRight;
                                } else if (document.body) {
                                        sTop = document.body.scrollTop;
                                        sLft = document.body.scrollRight;
                                };
                ...
                function onTimer() {
                        var xtmp = parseInt(vertical ? handle.offsetTop : handle.offsetRight, 10);
                ...
                function tweenTo(tx){
                        ...
                        tweenB    = parseInt(vertical ? handle.offsetTop : handle.offsetRight, 10);
                ...
                function pixelsToValue(px) {                                                                                            
                        ...
                        handle.style[vertical ? "top" : "right"] = (px || 0) + "px";
                        redrawRange();                                      
                ...
                function valueToPixels(val) { 
                        ...
                        handle.style[vertical ? "top" : "right"] = (scale ? percentToPixels(valueToPercent(value)) : vertical ? Math.round(((max - value) / step) * stepPx) : Math.round(((value - min) / step) * stepPx)) + "px"; 
                        redrawRange();                          
                ...
                function redrawRange() {
                        ...
                        if(vertical) {                       
                                ...
                                rangeBar.style["width"] = handle.offsetRight + "px"; 
                        };			
                };
