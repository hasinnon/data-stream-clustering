function init_sidebar() {
  var a = function () {
    ...
    var a = $BODY.outerHeight(),
      ...
      c = $RIGHT_COL.eq(1).height() + $SIDEBAR_FOOTER.height(),
      d = a < c ? c : a;
    (d -= $NAV_MENU.height() + b), $LEFT_COL.css("min-height", d);
  };
...
function init_daterangepicker_left() {
  if ("undefined" != typeof $.fn.daterangepicker) {
    ...
    $("#reportrange_left span").html(
      ...
      $("#reportrange_left").daterangepicker(b, a),
      ...
      $("#reportrange_left").on("apply.daterangepicker", function (a, b) {
        console.log(
          "apply event fired, start/end dates are " +
            b.startDate.format("MMMM D, YYYY") +
            " to " +
      ...
      $("#reportrange_left").on("cancel.daterangepicker", function (a, b) {
        console.log("cancel event fired");
      }),
      $("#options1").click(function () {
        $("#reportrange_left").data("daterangepicker").setOptions(b, a);
      }),
      $("#options2").click(function () {
        $("#reportrange_left")
