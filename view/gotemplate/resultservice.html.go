...
// source: D:\project\GO\gowork\src\datastream\view\template\resultservice.html
// DO NOT EDIT!
package gotemplate
...
func ResultServiceHandler(u datalayer.UserLogin, sid string, serv datalayer.Service, clu denstream.USresult, exctime string, w io.Writer) {
...
`)
  ...
  <div class="">
	...
	if exctime != "" {
		_buffer.WriteString(`
                  <h3>زمان اجرای عملیات خوشه بندی:</h3>
                  <h1>`)
		hero.EscapeHTML(exctime, _buffer)
		_buffer.WriteString(`</h1> 
                `)
	}
	_buffer.WriteString(`  
	...
	if serv.HDcount.Int32 == 2 {
		_buffer.WriteString(`
        <!-- نمودار داده‌های دریافتی -->
        <div class="row">

          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                  <h2>نمودار داده‌های دریافتی</h2>
                  <ul class="nav navbar-left panel_toolbox">    
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    </li>
                  </ul>
              ...
              <div class="x_content">
                <a>خوشه های متفاوت با رنگ های متفاوت جدا شده اند.</a>
                <br>
                <img src=`)
		hero.EscapeHTML("/Plot/a-"+sid+".png", _buffer)
