...
// source: D:\project\GO\gowork\src\datastream\view\template\under_construction.html
// DO NOT EDIT!
package gotemplate
...
func UnderConstructionHandler(w io.Writer) {
...
<html lang="fa" dir="rtl">
  <head>
    ...
    <title>بـاداده | در حال ساخت</title>
        ...
        <div class="col-md-12">
          <div class="col-middle">
            <div class="text-center text-center">
              <h1 class="error-number">در حال ساخت</h1>
              <h2>صفحه مورد نظر در حال ساخت است</h2>
              <p>لطفا از امکانات دیگر سایت استفاده کنید. از شکیبایی شما سپاس گذاریم.
              </p>
            </div>
          </div>
        </div>
